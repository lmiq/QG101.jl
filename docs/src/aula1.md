...
> "Quanto temos?" e "Do quê?"
> Essas duas perguntas estão no coração da química.
...
Uma propriedade é **extensiva** se depende da quantidade de matéria presente.
Uma propriedade é **intensiva** se independe da quantidade de matéria.
...
Pense assim:
  ...
  → A propriedade permanece igual?  →  INTENSIVA
```

---

###  6 — Exemplos: Extensivas vs. Intensivas
...
500 mL de água a 25 °C, d = 1,00 g/mL
  ...
  Densidade: 1,00 g/mL → 1,00 g/mL  ✓ (intensiva)
```

---

###  7 — Propriedades Intensivas como "Identidade" da Substância
...
> **Padrão:** extensiva / extensiva = intensiva.
> Isso explica por que densidade, massa molar e concentração molar são intensivas.
...
Onde:
- $n$ = quantidade de matéria (mol) — **extensiva**
- $m$ = massa (g) — **extensiva**
- $M$ = massa molar (g/mol) — **intensiva**
...
- $n$ = mols de soluto (extensiva)
- $V$ = volume da solução (extensiva)
- $C$ = concentração (intensiva) — unidade: mol/L = mol·L⁻¹ = M
...
**2.**
$n = C \times V = 0{,}100 \times 0{,}250 = 0{,}0250\ \text{mol}$
$m = 0{,}0250 \times 36{,}46 = 0{,}911\ \text{g}$

**3.** I / E / I / E

**4.**
$n = 11{,}2/22{,}4 = 0{,}500\ \text{mol}$
$N = 0{,}500 \times 6{,}022 \times 10^{23} = 3{,}01 \times 10^{23}\ \text{moléculas}$
$m = 0{,}500 \times 28{,}02 = 14{,}0\ \text{g}$
